...
/* font */
NK_API GdiFont* nk_gdifont_create(const char* name, int size, int weight);
...
GdiFont*
nk_gdifont_create(const char* name, int size, int weight)
{
    TEXTMETRICW metric;
    ...
    font->handle = CreateFontA(size, 0, 0, 0, weight, FALSE, FALSE, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, CLEARTYPE_QUALITY, DEFAULT_PITCH | FF_DONTCARE, name);
